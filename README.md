...
A live health monitoring dashboard for StarVC services — API, Database, Socket, and Voice. Built with Flask and a retro-inspired UI with dark/light theme support.
